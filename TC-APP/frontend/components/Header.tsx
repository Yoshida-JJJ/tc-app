...
export default function Header() {
    ...
    return (
        <header className="fixed top-4 md:top-6 left-0 right-0 z-50 px-4 md:px-0 pointer-events-none">
            <div className="pointer-events-auto mx-auto w-full md:max-w-4xl bg-brand-dark-light/95 backdrop-blur-xl border border-white/10 rounded-full px-4 py-3 shadow-2xl flex items-center justify-between">
                {/* Logo */}
